...
## 🖥️ Showcase
- [GitHub Repository - Data Science](https://github.com/nilocangerana/projetosCienciaDados-2021)
...
<Collapsible title="AI Pathfinding Project 📍">

## 🖥️ Showcase
- [GitHub Repository](https://github.com/nilocangerana/algoritmoIA-labirinto-2020)

---

Projects developed for Artificial Intelligence courses in Java, focusing on maze-solving and pathfinding algorithms, including Depth-First Search (DFS), Breadth-First Search (BFS), Best-First Search, A* , and Hill Climbing.
